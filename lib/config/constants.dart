class AppConstants {
  ...
  static const String weatherApiKey = 'YOUR_OPENWEATHER_API_KEY'; // Replace with your key

  // Unsplash API
  static const String unsplashBaseUrl = 'https://api.unsplash.com';
  static const String unsplashAccessKey = 'YOUR_UNSPLASH_ACCESS_KEY'; // Replace with your key
